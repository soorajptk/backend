...
const updateStudent=async(req,res)=>{
    ...
    res.status(StatusCodes.OK).json({msg:"student Details Updated Successfully !.."})
}
...
//   try{
//   const datas=await studentModel.aggregate([{ $search: {index:'search',text:{query:'MERN',path:{'wildcard': '*'}}}}]);
// console.log(datas)
//   }catch(err){
//     console.log(err)
//   }
...
//   try {
// const data=await studentModel.find({name:{$regex:/vy/}})
// console.log(data)
